...
This project has a PM folder at `<pm_folder>` (see `~/.config/project-management/projects.json` for the canonical mapping; `projects.json` lives at the user-specific XDG location from v1.3.0+, not at the skill root).
