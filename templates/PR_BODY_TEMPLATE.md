...
<!-- Bulleted list of the actual code changes. Group by area (API, UI, tests, etc.). -->

## Testing

<!-- What testing was done. Which test files were added/modified. Manual vs automated. -->
...
- [ ] roadmap/plans/<date>_slug.md — no redundant body H1; near-top `## Related` links exact done-pending mirror and copied relevant decision/feature/system/docs links
...
<!-- Anything reviewers should pay special attention to. Breaking changes, migrations, security. -->

## Rollout

<!-- How this ships. Migrations, feature flags, deployment steps, monitoring. -->

## Checklist

<!-- Generic PR checklist (adapt to your project). -->

- [ ] Tests pass locally
- [ ] Linter passes
- [ ] Docs updated (or "no doc changes needed" with reason)
- [ ] PM folder impact noted above
