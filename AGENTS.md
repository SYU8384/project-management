...
The full convention is documented in the project-management skill at `/home/syu/.agents/skills/project-management/SKILL.md` (specifically the "Coding Agent Integration" subsection).
